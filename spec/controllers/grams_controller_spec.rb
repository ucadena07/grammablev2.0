...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "should return a 404 message if we cannot find a gram with the id that is spicified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    it "shouldn't let a user who didnt create the gram update it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "should allow users to successfullyt update a gram" do
